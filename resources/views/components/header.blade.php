    ...
    <div class="container px-4 mx-auto">
        <div class="flex justify-between items-center py-4">
            ...
            <a href="/" class="flex items-center space-x-2">
                <!-- <span class="flex justify-center items-center w-10 h-10 text-2xl font-bold text-white rounded-md bg-primary"></span> -->
                <!-- <span class="hidden text-xl font-bold text-gray-800 sm:block"></span> -->
                <!-- <img src="{{ asset('img/AZUL.png') }}" alt="Mc Boutique" class="h-10 w-auto"> -->
            </a>
            <!-- Desktop Navigation -->
