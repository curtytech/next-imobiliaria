                ...
                <div class="p-8 mx-auto max-w-4xl bg-gray-50 rounded-2xl shadow-inner" x-data="loanSimulator">
                    <div class="grid grid-cols-1 gap-8 items-center md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="mb-6">
                                <label for="downPayment" class="block mb-2 font-semibold text-gray-700">Valor da
                                    Entrada</label>
                            ...
                            <div>
                                <label for="loanTerm" class="block mb-2 font-semibold text-gray-700">Prazo (em
                                    anos)</label>
                                <input type="range" id="loanTerm" min="5" max="35" step="1"
                                    x-model.number="loanTerm">
                                <p class="mt-2 text-2xl font-bold text-center text-primary" x-text="loanTerm + ' anos'">
                                </p>
                            </div>
                        </div>
                        <!-- Results -->
